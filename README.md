...
- 未打码的手机号、二维码、余额、订单、账号、日志
- 完整协议定义、商业美术资源和可复用业务资产

## 素材状态

当前版本已补充 3 张脱敏截图：启动加载、主游戏拉霸机界面、副游戏打动物界面。后续如补充 GIF 或视频，会统一放入 `assets/`，并在上传前确认没有手机号、二维码、余额、订单、用户信息、服务器地址或其他敏感内容。
